...
> идеи в продукты, измерять реакцию клиентов и затем выяснять, что
> делать дальше: pivot или persevere. Все успешные стартап-
> процессы должны быть настроены на ускорение этой петли обратной
> связи.
...
> *Перевод:* Урок MVP в том, что любая работа сверх той, что была
> нужна, чтобы начать научение, — это потери, какой бы важной она
> ни казалась в тот момент.
...
> *Перевод:* Стартапы существуют не только для того, чтобы делать
> продукт, зарабатывать деньги или даже обслуживать клиентов. Они
> существуют, чтобы научиться строить устойчивый бизнес. Это
> научение может быть валидировано научно — через регулярные
> эксперименты, позволяющие предпринимателям проверить каждый
> элемент своего видения.
...
> *Перевод:* Подлинная мера runway — сколько pivot'ов у стартапа
> ещё осталось: сколько возможностей у него совершить
> фундаментальное изменение своей бизнес-стратегии.
...
> *Перевод:* Один из важнейших уроков научного метода: если ты
> не можешь потерпеть неудачу, ты не можешь научиться.
