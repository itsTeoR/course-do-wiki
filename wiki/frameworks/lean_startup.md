...
tradition: [ries]
density: medium
related: [[build_measure_learn]], [[mvp]], [[pivot_or_persevere]], [[ries]], [[validated_learning_vs_effectuation]]
---
...
> *Перевод:* Стартап — это человеческая институция, созданная,
> чтобы делать новый продукт или сервис в условиях экстремальной
> неопределённости.
...
3. **Validated learning.**
   ...
   > *Перевод:* Стартапы существуют не только для того, чтобы
   > делать продукт, зарабатывать деньги или даже обслуживать
...
4. **Build-Measure-Learn.**
   ...
   > *Перевод:* Фундаментальная деятельность стартапа — превращать
   > идеи в продукты, измерять реакцию клиентов и затем выяснять,
   > что делать дальше: pivot или persevere. Все успешные стартап-
   > процессы должны быть настроены на ускорение этой петли
   > обратной связи.
...
> *Перевод:* Минимально жизнеспособный продукт (MVP) помогает
> предпринимателям как можно быстрее запустить процесс научения.
> При этом MVP не обязательно самый маленький продукт, какой можно
> вообразить; это просто самый быстрый способ пройти петлю
> Build-Measure-Learn с минимальным количеством усилий.
...
> определить, какие гипотезы проверять. Самые рискованные
> элементы плана стартапа, те, от которых всё зависит, я называю
> leap-of-faith assumptions — допущениями, требующими «прыжка
> веры». Два самых важных допущения — value hypothesis и growth
> hypothesis.
...
> *Перевод:* Pivot — не просто призыв к переменам. Это особый
> вид структурированного изменения, цель которого — проверить
> новую фундаментальную гипотезу о продукте, бизнес-модели и
> движке роста.
...
> *Перевод:* Успешные стартапы, как правило, концентрируются на
> одном движке роста — специализируясь на всём, что нужно, чтобы
> он работал.
...
> *Перевод:* Нельзя быть уверенным, что ты действительно
> понимаешь хоть какую-то часть бизнес-проблемы, пока не пойдёшь
> и не увидишь её сам, своими глазами. Недопустимо принимать
> что-либо как данность или полагаться на чужие отчёты.
...
> *Перевод:* Предпринимательство — это разновидность менеджмента.
> Нет, вы не ослышались. У нас радикально расходящиеся ассоциации
> с этими двумя словами, *entrepreneurship* и *management*. В
> последнее время одно слово кажется крутым, инновационным,
> волнующим — а другое скучным, серьёзным и пресным.
...
- Книга почти агрессивно анти-романтична. От евангелиста стартапа
  ожидаешь мифологию гениального основателя; Рис её методично
  разбирает уже в Introduction, настаивая, что «entrepreneurship is
  a kind of management» (рус.: «предпринимательство — разновидность
  менеджмента») и что миф о страсти и интуиции удобен только
  после победы, а до неё разрушителен (raw/ries/lean-startup.epub,
  Introduction, раздел «Origins of the Lean Startup»). Это не
  побочная оговорка — это ось книги.
